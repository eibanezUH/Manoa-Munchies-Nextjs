          ...
          <Card className="h-100 shadow-sm mb-3 no-hover">
            <Card.Body>
              ...
              <Card.Text>
                ...
                {' '}
                After logging in, go to your user profile and add your favorite cuisine and dietary preferences. This will recommend the best matching vendor to the user.
              </Card.Text>
            </Card.Body>
          </Card>
        </Col>
